...
def sql_service_job(fy,fy1):
    return """select A.SMM_TICKET_ID, A.SMM_ORG_ID, A.SMM_UNIT_MODEL, A.SMM_UNIT_ID, A.SMM_CUS_ID, A.SMM_ADDR, A.SMM_S_DATE, A.SMM_E_DATE, A.SMM_DESCRIPTION, A.SMM_SERVICE_ID, 
A.SMM_SERV_DATE, A.SMM_PRINCIPAL, A.SMM_SERV_REPLY, A.SMM_CLAIM, A.SMM_FINISHED, A.SMM_FINANCE_DATE, A.SMM_ACCOUNT_MONTH, A.SMM_CREATER_ID, A.SMM_CREATE_DATE, 
A.SMM_LASTUSERID, A.SMM_LASTTIME, A.SMM_STATUS, A.SMM_REMARK, A.SMM_S_TICKET_ID, A.SMM_PROJECT_BR, A.SMM_CREATE_PROJECT, A.SMM_IS_CREATEPRO, A.SMM_PROJECT_NAME, 
A.SMM_LINKMAN, A.SMM_TEL, A.SMM_SMR, A.SMM_SERVICE_TYPE, A.SMM_PZ_TYPE, A.SMM_INVOICED_CUS_ID, A.SMM_DEP_ID, A.SMM_SD_TICKET_ID, A.SMM_PHASE_ID, A.SMM_MACHINE_STATUS, 
A.SMM_REPORT_STATUS, A.SMM_CALL_DATE, A.SMM_HOTLINE_SUGGESTION, A.SMM_RESOLVES_RESULT, A.SMM_RELATE_TKTID from db2admin.SERV_MISSION_MIND A where left(SMM_ACCOUNT_MONTH,4) in ('%s', '%s')""" % (fy,fy1)

def sql_create_service_job(tb_to, primary_key):
    return """CREATE TABLE IF NOT EXISTS public.kp_service_job (
	        smm_ticket_id text NULL,
	        smm_org_id text NULL,
	        smm_unit_model text NULL,
	        smm_unit_id text NULL,
	        smm_cus_id text NULL,
	        smm_addr text NULL,
	        smm_s_date date NULL,
	        smm_e_date date NULL,
	        smm_description text NULL,
	        smm_service_id text NULL,
	        smm_serv_date timestamp NULL,
	        smm_principal text NULL,
	        smm_serv_reply text NULL,
	        smm_claim text NULL,
	        smm_finished text NULL,
	        smm_finance_date date NULL,
	        smm_account_month text NULL,
	        smm_creater_id text NULL,
	        smm_create_date timestamp NULL,
	        smm_lastuserid text NULL,
	        smm_lasttime timestamp NULL,
	        smm_status text NULL,
	        smm_remark text NULL,
	        smm_s_ticket_id text NULL,
	        smm_project_br text NULL,
	        smm_create_project text NULL,
	        smm_is_createpro text NULL,
	        smm_project_name text NULL,
	        smm_linkman text NULL,
	        smm_tel text NULL,
	        smm_smr float8 NULL,
	        smm_service_type text NULL,
	        smm_pz_type text NULL,
	        smm_invoiced_cus_id text NULL,
	        smm_dep_id text NULL,
	        smm_sd_ticket_id text NULL,
	        smm_phase_id text NULL,
	        smm_machine_status text NULL,
	        smm_report_status text NULL,
	        smm_call_date date NULL,
	        smm_hotline_suggestion text NULL,
	        smm_resolves_result text NULL,
	        smm_relate_tktid text NULL,
            CONSTRAINT %s_pkey PRIMARY KEY (%s)
            );""" % (tb_to, primary_key)