...
with DAG(
    dag_id='Salesforce_opportunity_ETL_dag',
    tags=['Salesforce'],
    ...
    task_Get_Salesforce_Data_Save_To_Datalake = SimpleHttpOperator(
        ...
        data={"stdate": '2021-01-01', "edate": '2021-05-31'},
        log_response=True
    )

    # 3. Upsert Salesforce To DATA Lake
    task_L_DL_SF_opportunity = PythonOperator(
        task_id='upsert_sf_opportunity_on_data_lake',
    ...
    task_RP_DL_SF_opportunity = PythonOperator(
        task_id='create_new_sf_opportunity_table',
        provide_context=True,
    ...
    task_CL_DL_SF_opportunity = PythonOperator(
        task_id='cleansing_sf_opportunity_data',
        provide_context=True,
    ...
    branch_op = BranchPythonOperator(
        task_id="check_existing_sf_opportunity_on_data_lake",
