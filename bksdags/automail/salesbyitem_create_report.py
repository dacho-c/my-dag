...
with DAG(
    dag_id='Auto_Create_2Hour_Salesbyitem_dag',
    tags=['Auto_Report'],
    schedule_interval='9 6-18/2 * * 1-5',
    ...
    task_api_auto_create_report = SimpleHttpOperator(
        task_id='auto_create_salesbyitem_report_to_sharepoint',
        http_conn_id='data_api',
        method='GET',
        endpoint='genreport/salebyitem',
        data={"lastdate": get_today(), "case": 0},
