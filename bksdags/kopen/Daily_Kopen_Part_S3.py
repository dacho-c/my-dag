...
with DAG(
    ...
    t3 = PythonOperator(
        ...
        op_kwargs={'From_Table': "PRODUCT", 'To_Table': "kp_part", 'Chunk_Size': 50000, 'Key': 'pro_komcode', 'Condition': "", 'Last_Days': 1}
    )
    t3.set_upstream(t2)
    ...
    t4 = PythonOperator(
        ...
        op_kwargs={'From_Table': "PRODUCT", 'To_Table': "kp_part", 'Chunk_Size': 50000, 'Key': 'pro_komcode', 'Condition': "", 'Last_Days': 2}
    )
    t4.set_upstream(t3)
