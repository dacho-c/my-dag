...
A.SMM_REPORT_STATUS, A.SMM_CALL_DATE, A.SMM_HOTLINE_SUGGESTION, A.SMM_RESOLVES_RESULT, A.SMM_RELATE_TKTID from SERV_MISSION_MIND A where left(SMM_ACCOUNT_MONTH,4) in ('%s', '%s')""" % (fy,fy1)
