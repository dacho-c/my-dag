...
A.UR_SMR, A.UR_DELIVER_DATE as UR_DELIVERY_DATE, A.UR_SMR_SOURCE, A.UR_LOCAL_DATE, A.UR_CREATEDTIME, A.UR_SHIPPING_DATE, A.UR_GCPS_DATE, A.UR_USED_DELIVER_DATE as UR_USED_DELIVERY_DATE, A.UR_SERVICE_TYPE, 
...
from kp_machine A where UR_MACHINE_CATEGORY = '1' and UR_STATUS <> '9') A
