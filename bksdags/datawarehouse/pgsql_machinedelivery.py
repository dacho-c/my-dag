def sql_ET_machine_cust():
    return """select A.UR_MODEL, A.UR_ID, A.UR_CUS, A.UR_REMARK, A.UR_SPECIAL_SERVICE, A.UR_SPEC, A.UR_NAME, BUR.BR_SNAME as MC_BRANCH, BUR.BR_REP_MEN as MC_BRANCH_REGION, A.UR_DATE, A.UR_FDJ_MODEL, A.UR_FDJ_CODE, A.UR_ZC_MODEL, A.UR_ZC_CODE, 
